...
- **Residual (polish, próxima ronda):** F10 (filter-select en Conductores/Almacenes + compartir/"Mover a Dev notes"); F3 user-picker en Nueva salida/Firmar; F8 Admin catálogos UI + miniatura SVG + fotos-web de cartilla; F4 bloquear entrada 0-renglones en origen. App = PROMPT-53 (BR6 Descartar, BR7 idioma, F4/F5 paridad).
