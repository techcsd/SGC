-- ============================================================================
-- AW3 (FASE 1.6) — el incentivo no cuenta echadas invalidadas.
-- Reproduce incentivo_generar_semana con `and not coalesce(rc.invalidada,false)`
-- en la echada titular y en el flag de echada duplicada. Todo lo demás igual.
-- ============================================================================
