-- ============================================================================
-- W7 (parte 3b) — suprimir avisos/notificaciones reales de vehículos de prueba.
-- Reescribe registrar_checklist_vehiculo y registrar_combustible_app: idénticas
-- a la versión vigente salvo que leen es_prueba del vehículo y envuelven el
-- bloque de avisos/notificaciones para NO emitir nada real cuando el vehículo
-- es de prueba. Aditivo/retrocompatible (misma firma).
-- ============================================================================
...
begin
  ...
  select placa, vencimiento_matricula, vencimiento_seguro, km_ultimo_mantenimiento, intervalo_mantenimiento_km, coalesce(es_prueba, false)
    into v_placa, v_mat_venc, v_seg_venc, v_km_ult, v_intervalo, v_es_prueba
