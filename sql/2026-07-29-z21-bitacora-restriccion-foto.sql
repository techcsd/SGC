-- ============================================================================
-- Z21 — Foto opcional por restricción de bitácora
-- PROMPT-7 · FASE 2 · ADITIVO
-- ============================================================================
-- Añade bitacora_restricciones.foto_path y hace que crear_bitacora_app lea
-- i->>'foto_path' de cada elemento de p_restricciones (retrocompatible: llega
-- nulo desde clientes viejos). El cuerpo del RPC se dumpeó desde la BD tras el
-- patch programático (solo cambió el bloque de inserción de restricciones).
-- ============================================================================

alter table sgc.bitacora_restricciones add column if not exists foto_path text;
