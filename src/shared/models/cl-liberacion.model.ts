...
export const CL_FIRMA_ROLES: { value: ClFirmaRol; label: string; hint: string; obligatoria: boolean }[] = [
  ...
  { value: 'cliente', label: 'Cliente', hint: 'Da conformidad', obligatoria: true },
  { value: 'mivhed', label: 'MIVHED', hint: 'Visita de liberación (cuando aplica)', obligatoria: false },
];
