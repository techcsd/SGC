...
export const DUDAS_CATEGORIAS: DudaCategoria[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        pregunta: '¿Por qué en unas pantallas veo TODAS las obras y en otras solo algunas?',
        respuesta:
          'Depende de para qué es el selector (matriz contexto×rol). En crear un CONDUCE, una RUTA, un despacho o al registrar personal de obra, TODOS ven todas las obras activas — un chofer entrega donde lo manden, así que necesita la lista entera. En cambio al crear una REQUISICIÓN, una ORDEN DE COMPRA o una BITÁCORA, el ingeniero ve solo SUS obras (las que tiene asignadas); un administrador ve todas. Si un selector te sale vacío, o de verdad no hay obras activas, o no tienes ninguna asignada en un contexto que las requiere — en ese caso pídele a un administrador que te asigne la obra. Las obras cerradas no aparecen en ningún selector.',
      },
      {
